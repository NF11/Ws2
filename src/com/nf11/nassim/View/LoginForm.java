...
//        this.dispose();
    ...
    private void jButton_LOGINActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException, SQLException {//GEN-FIRST:event_jButton_LOGINActionPerformed
        ...
        CLctrlGestionComptePersonne connexion = new CLctrlGestionComptePersonne() ;
        ResultSet result  = connexion.m_get_single(uname);
        ...
        if(count > 0)
        {
            ...
            JButton decrypter = new JButton("Decrypter");
            JButton importer = new JButton("Selectionnez un fichier");
            JPanel mainPan = new JPanel();
            JLabel instruct = new JLabel("Veuillez importer le fichier à décrypter");
            ...
            mainPan.add(decrypter);
            mainPan.add(importer);
            mainPan.add(exporter);
            mainPan.add(instruct);
            ...
            fenPrin.setTitle("Fenetre Principal");
            fenPrin.setSize(800, 600);
            fenPrin.setLocationRelativeTo(null);
            fenPrin.add(mainPan);
